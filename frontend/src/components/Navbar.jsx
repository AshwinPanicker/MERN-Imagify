  ...
  return (
    <div className='flex items-center justify-between py-4'>
      ...
      <div>
        ...
        <button onClick={()=>navigate('/buy')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 trasnition-all duration-700'>
